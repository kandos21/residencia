    ...
    if(isset($_POST['radio']))
    {
      ...
      foreach ($objHoja as $iIndice=>$objCelda) {
        ...
        if($_POST['radio']=='s'){
            ...
            (g_expediente, g_nombre_region, g_region, g_municipio, g_localidad, g_organizacion, g_elector_rep, g_nombre_rep, g_elector_ben, g_nombre_ben, g_monto_sol, g_cantidad, g_curp_ben, g_curp_rep)
            VALUES ('$n_expediente2','$nombre_region','$region','$municipio2','$localidad2','$organizacion2','$elector_rep','$nombre_rep','$elector_ben','$nombre_ben','$monto_sol','$cantidad','$curp_ben','$curp_rep')";
            ...
            VALUES('$nombre_rep','$elector_rep','$curp_rep')";

            $sql_beneficiario="INSERT INTO persona(nombre_persona,elector,curp,categoria)
            VALUES('$elector_ben','$nombre_ben','$curp_ben' )";
